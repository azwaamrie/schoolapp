    ...
    useEffect(() => {
        if (!isAddMode) {
            ...
            userService.getById(id).then(user => {
                const fields = [ 'firstName', 'lastName', 'course', 'role'];
        ...
        <form onSubmit={handleSubmit(onSubmit)} onReset={reset}>
            ...
            <div className="form-row">
                <div className="form-group col-7">
                    <label>Course</label>
                    <input name="course" type="text" ref={register} className={`form-control ${errors.course ? 'is-invalid' : ''}`} />
